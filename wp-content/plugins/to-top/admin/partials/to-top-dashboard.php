                        ...
                        <table class="form-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo '<input type="text" class="to_top_icon_color" name="to_top_options[icon_color]" value="' . esc_attr($settings['icon_color']) . '"/>';
                                        ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo '<input type="text" class="to_top_icon_bg_color" name="to_top_options[icon_bg_color]" value="' . esc_attr($settings['icon_bg_color']) . '"/>';
                                        ?>
                                    </td>
                                </tr>
                        ...
                        <table class="form-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo '<input type="text" size="65" id="to_top_options[image_alt]" name="to_top_options[image_alt]" value="' . esc_attr($settings['image_alt']) . '"/>';
                                        ?>
                                    </td>
                                </tr>
                            </tbody>
